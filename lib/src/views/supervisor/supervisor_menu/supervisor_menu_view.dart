...
import 'package:premier/src/views/supervisor/supervisor_menu/supervisor_menu_view_model.dart';
import 'package:stacked/stacked.dart';

class SupervisorMenuView extends StatelessWidget {
  const SupervisorMenuView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<SupervisorMenuViewModel>.reactive(
      ...
      viewModelBuilder: () => SupervisorMenuViewModel(context),
    );
  }
}
